...
libseccomp_url="https://ghproxy.com/https://github.com/seccomp/libseccomp"
libseccomp_tarball="libseccomp-${libseccomp_version:-}.tar.gz"
libseccomp_tarball_url="${libseccomp_url}/releases/download/v${libseccomp_version}/${libseccomp_tarball}"

nerdctl_url="https://ghproxy.com/https://github.com/containerd/nerdctl"
...
seautil_url="https://ghproxy.com/https://github.com/sealerio/sealer"
...
crictl_url="https://ghproxy.com/https://github.com/kubernetes-sigs/cri-tools"
...
if [ "${cri}" = "docker" ]; then
  ...
  docker_url="https://ghproxy.com/https://github.com/osemp/moby"
  ...
  containerd_url="https://ghproxy.com/https://github.com/containerd/containerd"
...
wget -c -t 0 -T 100 "${cri_tarball_amd64_url}" && mv "${cri_tarball_amd64}" "amd64/cri/${cri}.tar.gz"
wget -c -t 0 -T 100 "${cri_tarball_arm64_url}" && mv "${cri_tarball_arm64}" "arm64/cri/${cri}.tar.gz"
